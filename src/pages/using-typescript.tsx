...
const UsingTypescript: React.FC<PageProps<DataProps>> = ({ data, location }) => (
  <Layout>
    ...
    <p>
      This means that you can create and write <code>.ts/.tsx</code> files for your pages, components, and{' '}
      <code>gatsby-*</code> configuration files (for example <code>gatsby-config.ts</code>).
    </p>
    <p>
